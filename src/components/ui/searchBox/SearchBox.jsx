...
function SearchBox() {
  ...
  return (
    <div className="flex-grow h-full relative">
      <form>
        <input
          className={`flex pr-[50px] ${filteredArray.length>0 && searchValue?"rounded-b-none rounded-t-[10px]":"rounded-[10px]"} gap-[2px] items-center bg-[#e4e4e4] w-full h-[44px] placeholder:text-[16px] focus:outline-none`}
